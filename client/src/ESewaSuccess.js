...
export default function ESewaSuccess() {
  return (
    <div className="esewa-success-modal" style={{position:'fixed',top:0,left:0,right:0,bottom:0,display:'flex',alignItems:'center',justifyContent:'center',zIndex:3000}}>
      <div style={{background:'#fff',borderRadius:12,padding:'2.5rem 2.5rem',boxShadow:'0 4px 24px rgba(0,0,0,0.14)',textAlign:'center',maxWidth:400}}>
        <h2 style={{color:'#0090d0'}}>Payment Successful!</h2>
        <p>Your payment was received and your order is now complete.</p>
